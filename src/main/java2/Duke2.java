...
public class Duke {
    /**
     * To update: Processes.DukeException, Textfile update when starting build
     */
    
    public static void main(String[] args) throws IOException {
        String directory = "C:\\Users\\GY\\Downloads\\CS2113T\\duke\\data\\tasks.txt";
        Scanner input = new Scanner(System.in);
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy HHmm"); //parser
        dateFormat.setLenient(false); //parser
